...
async function testGmailDelivery() {
    ...
    try {
        ...
        const connected = await (0, sendVerificationEmail_1.testEmailConnection)();
        if (!connected) {
        ...
        const token = (0, sendVerificationEmail_1.generateVerificationToken)();
...
// Run the test
testGmailDelivery();
//# sourceMappingURL=testGmailSend.js.map