...
exports.testEmailConnection = exports.resendVerificationEmail = exports.sendVerificationEmail = exports.hashToken = exports.generateVerificationToken = void 0;
// src/helper/emailVerificationHelper.ts
const nodemailer_1 = __importDefault(require("nodemailer"));
const crypto_1 = __importDefault(require("crypto"));
const isDevelopment = process.env.NODE_ENV !== "production";
const transporter = nodemailer_1.default.createTransport(isDevelopment
    ? {
 ...
 */
const sendVerificationEmail = async ({ to, token, username = "User", }) => {
    try {
 ...
 */
const resendVerificationEmail = async (params) => {
    console.log(`🔄 Resending verification email to ${params.to}`);
    return await (0, exports.sendVerificationEmail)(params);
};
